...
export interface ApiCtaTimeTableCtaTimeTable extends Schema.SingleType {
  collectionName: 'cta_time_tables';
  info: {
    singularName: 'cta-time-table';
    pluralName: 'cta-time-tables';
    displayName: 'CTA Time Table';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::cta-time-table.cta-time-table',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNetworkNetwork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cta: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'To find out more please contact us:'>;
    email: Attribute.Email & Attribute.Required;
    location: Attribute.String & Attribute.Required;
    map: Attribute.String & Attribute.Required;
    mapLocationMetadata: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSermonSermon extends Schema.CollectionType {
  ...
  attributes: {
    ...
    guide: Attribute.Media<'files', true>;
